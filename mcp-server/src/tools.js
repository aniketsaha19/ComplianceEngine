...
export function registerTools(server) {
    ...
    server.registerTool(
        'add_rule',
        {
            ...
            description:
                'Create a compliance rule for the tenant. Thresholds are percentages for the *_pct rule types ' +
                'and a count for min_holdings_count.',
            inputSchema: {
                ...
                threshold: z.number().describe('Percent (0-100) for *_pct rules, or a holdings count'),
